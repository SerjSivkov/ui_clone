...
mixin _$CaptureSession {
 ...
 String get id; String? get targetPackage; String? get targetLabel; CaptureStatus get status; List<String> get screenshotPaths; int get skippedDuplicates;/// Seconds left before hard auto-stop; null until session starts.
 int? get remainingSec;/// True after native time_warning (near limit).
 bool get timeLimitWarning;/// True while UI Clone itself is in the foreground (frames skipped).
 ...
 String? get structuredJson;/// 0..1 while [status] is analyzing; null otherwise.
 double? get analysisProgress;/// preparing | uploading | waiting
 String? get analysisPhase; int get analysisImagesDone; int get analysisImagesTotal;/// Rough ETA in seconds while analyzing.
 int? get analysisEtaSec; String? get errorMessage; DateTime? get startedAt; DateTime? get finishedAt;
...
as List<String>,skippedDuplicates: null == skippedDuplicates ? _self.skippedDuplicates : skippedDuplicates // ignore: cast_nullable_to_non_nullable
as int,remainingSec: freezed == remainingSec ? _self.remainingSec : remainingSec // ignore: cast_nullable_to_non_nullable
as int?,timeLimitWarning: null == timeLimitWarning ? _self.timeLimitWarning : timeLimitWarning // ignore: cast_nullable_to_non_nullable
as bool,ownAppInForeground: null == ownAppInForeground ? _self.ownAppInForeground : ownAppInForeground // ignore: cast_nullable_to_non_nullable
as bool,usageAccessGranted: null == usageAccessGranted ? _self.usageAccessGranted : usageAccessGranted // ignore: cast_nullable_to_non_nullable
...
as String?,analysisProgress: freezed == analysisProgress ? _self.analysisProgress : analysisProgress // ignore: cast_nullable_to_non_nullable
as double?,analysisPhase: freezed == analysisPhase ? _self.analysisPhase : analysisPhase // ignore: cast_nullable_to_non_nullable
as String?,analysisImagesDone: null == analysisImagesDone ? _self.analysisImagesDone : analysisImagesDone // ignore: cast_nullable_to_non_nullable
as int,analysisImagesTotal: null == analysisImagesTotal ? _self.analysisImagesTotal : analysisImagesTotal // ignore: cast_nullable_to_non_nullable
as int,analysisEtaSec: freezed == analysisEtaSec ? _self.analysisEtaSec : analysisEtaSec // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  int skippedDuplicates;
...
@override@JsonKey() final  bool timeLimitWarning;
/// True while UI Clone itself is in the foreground (frames skipped).
@override@JsonKey() final  bool ownAppInForeground;
/// Usage access granted (needed to filter by target package).
@override@JsonKey() final  bool usageAccessGranted;
...
@override final  double? analysisProgress;
/// preparing | uploading | waiting
@override final  String? analysisPhase;
@override@JsonKey() final  int analysisImagesDone;
@override@JsonKey() final  int analysisImagesTotal;
/// Rough ETA in seconds while analyzing.
@override final  int? analysisEtaSec;
